...
{
    [RequireComponent(typeof (AeroplaneController2D))]
    public class AeroplaneAiControl2D : MonoBehaviour
    {
        ...
        private AeroplaneController2D m_AeroplaneController;  // The aeroplane controller that is used to move the plane
        ...
        private void Awake()
        {
            ...
            m_AeroplaneController = GetComponent<AeroplaneController2D>();
